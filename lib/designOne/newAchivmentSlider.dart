...
class NewAchivmentSlider extends StatefulWidget {
  final List<Map<String, dynamic>> achievements; // Achievements data

  NewAchivmentSlider({required this.achievements});

  @override
  _NewAchivmentSliderState createState() =>
      _NewAchivmentSliderState();
}

class _NewAchivmentSliderState
    extends State<NewAchivmentSlider> {
          ...
          children: [
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemBuilder: (context, index) {
                  double scale =
                  (index == currentPage.round()) ? 1.0 : 0.8;
  ...
  Widget _buildAchievementCard(
      Map<String, dynamic> achievement, int index, bool isDesktop) {
    return Card(
      color: Colors.white,
