...
// }
//
// class _UserDataPageForAllState extends State<UserDataPageForAll> with TickerProviderStateMixin {
...
//   }
//
//   // Build modern stat card for metrics
...
//       child: Row(
//         children: [
//           Icon(icon, size: 20, color: Color(0xFF4C6EF5)),
//           SizedBox(width: 12),
//           Text(
//             "$label: ",
//             style: GoogleFonts.poppins(
...
//             crossAxisAlignment: CrossAxisAlignment.start,
//             children: [
//               // 🟦 1. Shop Header Section - Visual First
//               _buildShopHeaderSection(),
//               SizedBox(height: 20),
//
//               // 🟩 2. Status & Basic Info Section
//               Padding(
//                 padding: const EdgeInsets.symmetric(horizontal: 16.0),
//                 child: _buildStatusInfoSection(),
//               ),
//               SizedBox(height: 20),
//
...
//               SizedBox(height: 25),
//
//               // 🟧 4. Categories & Features Section (Tabs)
//               _buildCategoriesTabSection(),
//               SizedBox(height: 25),
//
//               // 🟪 5. Additional Features Section
//               Padding(
//                 padding: const EdgeInsets.symmetric(horizontal: 16.0),
//                 child: Column(
//                   crossAxisAlignment: CrossAxisAlignment.start,
...
//                                 padding: EdgeInsets.all(10),
//                                 decoration: BoxDecoration(
//                                   color: Color(0xFF4C6EF5), // DigiLocal Primary Blue
...
//                                                 },
//                                                 style: ElevatedButton.styleFrom(
//                                                   backgroundColor: Color(0xFF4C6EF5), // DigiLocal Primary Blue
